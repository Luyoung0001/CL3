...
// EXCEPTION Registers
#define MEPC_R    (topp->rootp->top__DOT__u_CL3Top__DOT__core__DOT__csr__DOT__csr_rf__DOT__csr_mepc_q)
#define MTVEC_R   (topp->rootp->top__DOT__u_CL3Top__DOT__core__DOT__csr__DOT__csr_rf__DOT__csr_mtvec_q)
#define MCAUSE_R  (topp->rootp->top__DOT__u_CL3Top__DOT__core__DOT__csr__DOT__csr_rf__DOT__csr_mcause_q)
#define MSTATUS_R (topp->rootp->top__DOT__u_CL3Top__DOT__core__DOT__csr__DOT__csr_rf__DOT__csr_sr_q)
#define MTVAL_R   (topp->rootp->top__DOT__u_CL3Top__DOT__core__DOT__csr__DOT__csr_rf__DOT__csr_mtval_q)
