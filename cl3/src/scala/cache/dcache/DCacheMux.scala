...
class dcache_mux(p: DCacheParams) extends Module {
  ...
  val (cpuReq, cpuResp, cacheReq, cacheResp, unReq, unResp) =
    (io.cpu.req, io.cpu.resp, io.backs.cached.req, io.backs.cached.resp, io.backs.uncached.req, io.backs.uncached.resp)
