...
// SRAM
class S55NLLG1PH_X64Y1D20(val addrBits: Int, val dataBits: Int) extends ExtModule with HasExtModuleResource {
...
class S55NLLG1PH_X128Y2D64(val addrBits: Int, val dataBits: Int) extends ExtModule with HasExtModuleResource {
