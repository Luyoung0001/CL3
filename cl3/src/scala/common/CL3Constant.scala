...
trait CSRTrapNO {
  ...
  private val addrSet = Seq(
    EXCEPTION_ILLEGAL_INSTRUCTION, EXCEPTION_MISALIGNED_LOAD, EXCEPTION_FAULT_LOAD,
    EXCEPTION_MISALIGNED_STORE, EXCEPTION_FAULT_STORE,
    EXCEPTION_PAGE_FAULT_LOAD, EXCEPTION_PAGE_FAULT_STORE
  )
